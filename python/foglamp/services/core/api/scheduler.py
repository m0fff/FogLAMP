...
async def enable_schedule(request):
    ...
    :Example: curl -X PUT  http://localhost:8081/foglamp/schedule/enable/ac6dd55d-f55d-44f7-8741-984604bf2384
    """
...
async def disable_schedule(request):
    ...
    :Example: curl -X PUT  http://localhost:8081/foglamp/schedule/disable/ac6dd55d-f55d-44f7-8741-984604bf2384
    """
