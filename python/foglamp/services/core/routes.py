...
def setup(app):
    ...
    app.router.add_route('PUT', '/foglamp/schedule/enable/{schedule_id}', api_scheduler.enable_schedule)
    app.router.add_route('PUT', '/foglamp/schedule/disable/{schedule_id}', api_scheduler.disable_schedule)
